...
namespace LMS_Datas
{
    ...
    public partial class LoyaltyManagementSystemEntities : DbContext
    {
        ...
        public virtual DbSet<SuperAdminLogin> SuperAdminLogins { get; set; }
        ...
        public virtual ObjectResult<InsertUpdateSelectCustomerVoucher_Result> InsertUpdateSelectCustomerVoucher(Nullable<int> aId, Nullable<int> customerId, Nullable<int> voucherId, Nullable<int> adminId, Nullable<int> aMode, Nullable<int> deskId, Nullable<int> assignNo)
        {
            var aIdParameter = aId.HasValue ?
                new ObjectParameter("AId", aId) :
                new ObjectParameter("AId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InsertUpdateSelectCustomerVoucher_Result>("InsertUpdateSelectCustomerVoucher", aIdParameter, customerIdParameter, voucherIdParameter, adminIdParameter, aModeParameter, deskIdParameter, assignNoParameter);
        }
        ...
        public virtual ObjectResult<InsertUpdateSelectVoucher_Result> InsertUpdateSelectVoucher(Nullable<int> aId, Nullable<int> voucherNo, string voucherName, Nullable<System.DateTime> validFrom, Nullable<System.DateTime> validTo, Nullable<int> discountPerId, Nullable<int> packageId, Nullable<int> aMode, Nullable<bool> active)
        {
            var aIdParameter = aId.HasValue ?
                new ObjectParameter("AId", aId) :
                new ObjectParameter("AId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InsertUpdateSelectVoucher_Result>("InsertUpdateSelectVoucher", aIdParameter, voucherNoParameter, voucherNameParameter, validFromParameter, validToParameter, discountPerIdParameter, packageIdParameter, aModeParameter, activeParameter);
        }
    }
}
