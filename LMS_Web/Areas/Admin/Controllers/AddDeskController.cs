...
using LMS_Web.Areas.Admin.Models;
...
namespace LMS_Web.Areas.Admin.Controllers
{
    public class AddDeskController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Index(AddDeskModel model, FormCollection form, HttpPostedFileBase files)
        {
            try
            {
                ...
                {
                    int Adminid = Convert.ToInt32(TempData.Peek("user"));
